...
export const metadata: Metadata = {
  ...
  description:
    "Book a table at any Malt Barrel & Fire location. WhatsApp, online reservations, or private event enquiries.",
};
...
const bookingOptions = [
  {
    ...
    description:
      "Send us a message on WhatsApp to reserve your table. Quick, easy, and personal.",
    status: "Coming Soon",
    icon: (
  ...
  },
  {
    ...
    description:
      "Reserve your preferred date, time, and number of guests through our online booking system.",
    status: "Coming Soon",
    icon: (
      ...
      <div className="mx-auto max-w-4xl px-6 py-20 md:px-12">
        ...
        <div className="text-center">
          ...
          <p className="mx-auto mt-8 max-w-lg text-lg text-warm-gray leading-relaxed">
            Choose your preferred way to book. We&apos;re setting up our booking systems —
        ...
        <div className="mt-20 grid gap-6 md:grid-cols-3">
          {bookingOptions.map((option) => (
            <div
              key={option.title}
              className="group relative overflow-hidden rounded-sm border border-charcoal-light p-8 transition-all duration-500 hover:border-amber/30 hover:bg-charcoal/30"
            >
              <div className="absolute top-0 left-0 h-1 w-0 bg-amber transition-all duration-700 group-hover:w-full" />
              <div className="mb-6 text-amber/70">{option.icon}</div>
              ...
              <div className="mt-6">
                {option.href ? (
                  ...
                  <span className="inline-block rounded-sm border border-charcoal-light px-6 py-2.5 text-xs tracking-[0.2em] uppercase text-warm-gray/60">
                    {option.status}
                  </span>
                )}
              </div>
        ...
        <div className="mt-24 border-t border-charcoal-light pt-16 text-center">
          ...
          <p className="mx-auto mt-4 max-w-md text-warm-gray">
            Call any of our locations directly to book your table today.
          </p>
